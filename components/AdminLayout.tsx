        ...
        <div className="flex flex-col p-4 gap-6">
          ...
          <nav className="flex flex-col gap-2">
            ...
            <CollapsibleNavSection title="STAFF MANAGEMENT" icon="work" iconColor="bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400" isCollapsed={isSidebarCollapsed} active={
              ...
              <NavItem to="/admin/apc/list" icon="table_view" label="Staff SAPC" active={isActive('/admin/apc/list')} isLocked={isModuleLocked('apc') && !isSuperAdmin} isCollapsed={isSidebarCollapsed} />
              <NavItem to="/admin/apc/custom" icon="person_add" label="Custom SAPC" active={isActive('/admin/apc/custom')} isLocked={isModuleLocked('apc') && !isSuperAdmin} isCollapsed={isSidebarCollapsed} />
              <NavItem to="/admin/apc/random" icon="casino" label="Random SAPC" active={isActive('/admin/apc/random')} isLocked={isModuleLocked('apc') && !isSuperAdmin} isCollapsed={isSidebarCollapsed} />
              ...
              <NavItem to="/admin/assignments/board" icon="view_kanban" label="Custom-Post" active={isActive('/admin/assignments/board')} isLocked={isModuleLocked('posting') && !isSuperAdmin} isCollapsed={isSidebarCollapsed} />
              <NavItem to="/admin/assignments/random" icon="shuffle" label="Random-Post" active={isActive('/admin/assignments/random')} isLocked={isModuleLocked('posting') && !isSuperAdmin} isCollapsed={isSidebarCollapsed} />
