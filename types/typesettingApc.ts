export interface TypesettingAPCRecord {
    id: string;
    file_no: string;
    name: string;
...
export interface TypesettingAPCListResponse {
    items: TypesettingAPCRecord[];
    total: number;
    skip: number;
    limit: number;
}

export interface TypesettingAPCCreate {
    file_no: string;
    name: string;
    conraiss?: string | null;
    station?: string | null;
...
export type TypesettingAPCUpdate = Partial<TypesettingAPCCreate>;
