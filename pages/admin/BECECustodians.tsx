...
const BECECustodians: React.FC = () => {
    ...
    const [custodians, setCustodians] = useState<BECECustodian[]>([]);
    const [filteredCustodians, setFilteredCustodians] = useState<BECECustodian[]>([]);
    const [displayedCustodians, setDisplayedCustodians] = useState<BECECustodian[]>([]);
    const [loading, setLoading] = useState(true);
    const [total, setTotal] = useState(0);
    const [page, setPage] = useState(1);
    const [limit, setLimit] = useState(10);
    const [sortField, setSortField] = useState<keyof BECECustodian | null>(null);
